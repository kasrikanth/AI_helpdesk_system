...
const LoginPage = ({ onLogin }) => {
  ...
  const handleLogin = (user) => {
    ...
    // navigate(`/${user.id}`);
    navigate(`/login/?operations=${user.id}`);
      ...
      <Container maxWidth="md" sx={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', py: 4 }}>
        ...
        <Box sx={{ mt: 6, p: 3, backgroundColor: '#242424', borderRadius: '8px', textAlign: 'center', border: '1px solid #333333' }}>
          <Typography variant="body2" sx={{ color: '#999999' }}>
            This is a static demonstration of the ESI AI HelpDesk system. All data is representative and for evaluation purposes only.
          </Typography>
        </Box>
      </Container>
